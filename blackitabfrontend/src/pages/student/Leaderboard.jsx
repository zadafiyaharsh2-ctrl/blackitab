      ...
      <div className="border border-gray-200 dark:border-white/10 rounded-xl p-5 sm:p-6 bg-white dark:bg-white/[0.02]">
        ...
        {!loading && users.length > 0 && (
          <div className="mt-5 grid grid-cols-1 sm:grid-cols-3 gap-3">
            <div className="border border-gray-200 dark:border-white/10 rounded-lg p-3.5 bg-gray-50 dark:bg-white/[0.03]">
              <div className="text-[11px] uppercase tracking-wider font-bold text-gray-500 dark:text-gray-400">Top Scorer</div>
              <div className="mt-1 text-base font-bold text-gray-900 dark:text-white truncate">{topUser?.name || 'N/A'}</div>
            </div>

            <div className="border border-gray-200 dark:border-white/10 rounded-lg p-3.5 bg-gray-50 dark:bg-white/[0.03]">
              <div className="text-[11px] uppercase tracking-wider font-bold text-gray-500 dark:text-gray-400">Your Rank</div>
              <div className="mt-1 text-base font-bold text-gray-900 dark:text-white">{currentUserEntry ? `#${currentUserEntry.rank}` : 'Unranked'}</div>
            </div>

            <div className="border border-gray-200 dark:border-white/10 rounded-lg p-3.5 bg-gray-50 dark:bg-white/[0.03]">
              <div className="text-[11px] uppercase tracking-wider font-bold text-gray-500 dark:text-gray-400">Highest XP</div>
              <div className="mt-1 text-base font-bold text-gray-900 dark:text-white">{topXp.toLocaleString()}</div>
            </div>
          </div>
        )}
      </div>
          ...
          <div className="border border-gray-200 dark:border-white/10 rounded-xl p-3 sm:p-4 bg-white dark:bg-white/[0.02]">
            {rest.length > 0 ? (
              ...
              <div className="text-center py-10 text-sm text-gray-500 dark:text-gray-400">
                Only top performers are available right now.
              </div>
            )}
          </div>
        </>
