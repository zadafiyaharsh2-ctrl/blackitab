...
const PlaylistList = () => {
    ...
    return (
        <div className="min-h-screen bg-transparent text-white pt-28 pb-12 px-4 md:px-8">
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16 border-b border-white/5 pb-8">
                    ...
                    <div className="relative w-full md:w-96 group">
                        <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                            <FaSearch className="text-gray-500 group-focus-within:text-white transition-colors" />
                        </div>
                        <input 
                            type="text" 
                            ...
                            className="w-full bg-[#18181A] border border-[#27272A] rounded-full py-3.5 pl-11 pr-4 text-sm text-white placeholder-gray-600 focus:outline-none focus:border-white/20 focus:bg-[#202022] transition-all"
                        />
                    </div>
                </div>
                ...
                {loading ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                        {[1, 2, 3, 4, 5, 6, 7, 8].map((n) => (
                            <div key={n} className="bg-[#18181A] rounded-xl aspect-[4/3] animate-pulse border border-white/5"></div>
                        ))}
                    </div>
                    ...
                    <div className="flex flex-col items-center justify-center py-32 text-center text-gray-500">
                        ...
                        <h3 className="text-xl font-medium text-white mb-1">No series found</h3>
