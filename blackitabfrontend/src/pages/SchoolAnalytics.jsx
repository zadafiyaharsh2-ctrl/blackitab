...
const SchoolAnalytics = () => {
  ...
  return (
    <div className="min-h-screen p-6">
      ...
      {/* Access Mechanism */}
      <div className="max-w-7xl mx-auto mb-12">
        <div className={`${isDark ? 'bg-gray-800/50 border-gray-700' : 'bg-white border-gray-200'} rounded-2xl p-8 border backdrop-blur-md text-center`}>
          ...
          <p className={`${isDark ? 'text-gray-300' : 'text-gray-600'} max-w-2xl mx-auto text-lg`}>
      ...
      <div className="max-w-7xl mx-auto">
        <div className={`${isDark ? 'bg-gradient-to-r from-red-900/30 to-orange-900/30 border-red-700/50' : 'bg-gradient-to-r from-red-50 to-orange-50 border-red-200'} rounded-2xl p-8 border backdrop-blur-md`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            {/* Example Card */}
            <div className={`${isDark ? 'bg-gray-800' : 'bg-white'} rounded-xl p-6 border ${isDark ? 'border-gray-700' : 'border-gray-200'} shadow-lg transform rotate-1 hover:rotate-0 transition-transform duration-300`}>
              ...
              <button className="w-full py-2 bg-red-500 hover:bg-red-600 text-white rounded-lg font-semibold transition-colors">
