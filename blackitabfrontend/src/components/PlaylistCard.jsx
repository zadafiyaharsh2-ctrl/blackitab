...
const PlaylistCard = ({ playlist, onDelete }) => {
  ...
  return (
    <motion.div
      ...
      className="bg-gray-900 rounded-xl overflow-hidden cursor-pointer group relative border border-white/5 hover:border-purple-500/30 transition-all shadow-lg hover:shadow-purple-500/10"
    ...
    >
      ...
      <div className="relative aspect-video bg-gray-800 overflow-hidden">
        {playlist.thumbnail ? (
          ...
          <div className="w-full h-full flex flex-col items-center justify-center text-gray-600 bg-gradient-to-br from-gray-800 to-gray-900">
        ...
        {/* Video Count Badge */}
        <div className="absolute bottom-2 right-2 bg-black/80 backdrop-blur-md text-white text-xs px-2 py-1 rounded-md flex items-center gap-1 font-medium border border-white/10">
          <FaListUl size={10} />
         ...
         {isOwner && (
            <div className="absolute top-2 right-2 z-20">
                ...
                {showMenu && (
                    <div className="absolute right-0 top-full mt-1 w-32 bg-[#222] border border-white/10 rounded-lg shadow-xl overflow-hidden py-1">
                        <button 
                            onClick={handleDelete}
                            className="w-full text-left px-3 py-2 text-xs font-medium text-red-400 hover:bg-white/5 flex items-center gap-2"
                        >
