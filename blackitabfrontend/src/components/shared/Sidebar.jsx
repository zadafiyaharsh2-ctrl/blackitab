      ...
      >
        ...
        <div className="p-4 border-t border-gray-200/50 dark:border-white/10 bg-gray-50 dark:bg-transparent">
          ...
          <button
            ...
            className={`w-full flex items-center ${isOpen ? 'px-3 py-3 justify-start gap-3' : 'px-0 py-3 justify-center'} text-[13px] font-semibold tracking-wide rounded-xl transition-colors text-gray-500 dark:text-gray-400 hover:bg-rose-50 dark:hover:bg-white/5 hover:text-rose-600 dark:hover:text-rose-400`}
            title="Report an Issue"
          >
            <span className="text-[16px] text-gray-400 dark:text-gray-500"><MdReportProblem /></span>
          ...
          <Link
            to="/contact"
            onClick={handleNavClick}
            className={`w-full flex items-center ${isOpen ? 'px-3 py-3 justify-start gap-3' : 'px-0 py-3 justify-center'} text-[13px] font-semibold tracking-wide rounded-xl transition-colors text-gray-500 dark:text-gray-400 hover:bg-indigo-50 dark:hover:bg-white/5 hover:text-indigo-600 dark:hover:text-indigo-400`}
            title="Contact Us"
          >
            <span className="text-[16px] text-gray-400 dark:text-gray-500"><FaEnvelope /></span>
